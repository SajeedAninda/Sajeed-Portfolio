        ...
        <div id='aboutme' className='aboutBg h-fit'>
            <div className='w-[80%] mx-auto'>
                ...
                <div className='flex flex-col lg:flex-row justify-center items-center'>
                    ...
                    <div className='flex-1 py-12' data-aos="flip-right">
                        <motion.div whileHover={{ scale: 1.05 }} className='text-semibold text-xl space-y-3 border-2 border-[#863d8f] p-6 rounded-md hover:bg-[#282e46] hover:border-2 hover:border-[#282e46] group cursor-pointer text-center md:text-left'>
